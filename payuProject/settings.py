"""
Django settings for payuProject project.
...
SECRET_KEY = 'gt5ptyk$!z+i+_--s9w*!cl231oa@95i0&94w&drq_web^8&gx'
...
WSGI_APPLICATION = 'payuProject.wsgi.application'
